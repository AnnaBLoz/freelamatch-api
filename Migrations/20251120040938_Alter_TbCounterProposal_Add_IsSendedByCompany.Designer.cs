...
namespace freela_match_api.Migrations
{
    ...
    [Migration("20251120040938_Alter_TbCounterProposal_Add_IsSendedByCompany")]
    partial class Alter_TbCounterProposal_Add_IsSendedByCompany
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FreelaMatchAPI.Models.Reviews", b =>
                {
                    ...
                    b.HasOne("FreelaMatchAPI.Models.User", "Receiver")
                        .WithMany("ReviewsReceived")
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("FreelaMatchAPI.Models.User", "Reviewer")
